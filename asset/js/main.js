...
(function ($) {
  ...
  // contact form - now handled by EmailJS directly in HTML files
  var ajaxContactForm = function () {
    // Contact form is now handled by EmailJS directly in each HTML file
  ...
  var dallasTime = function () {
    ...
    const dallasTime = new Intl.DateTimeFormat("en-US", options).format(
      new Date()
    );
    $("#dallas-time").text(dallasTime);
  };

  var updateDallasTime = function () {
    setInterval(dallasTime, 1000);
  };
